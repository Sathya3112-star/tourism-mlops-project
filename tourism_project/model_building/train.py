...
mlflow.set_experiment("MLOps_CICD_experiment_2")
...
numeric_features = ['Age','MonthlyIncome','NumberOfTrips']

#Making a list of all catrgorical variables
cat_col=['TypeofContact', 'CityTier','Occupation', 'Gender',
...
with mlflow.start_run():
    ...
    model_path = "best_toursim_opt_model_v1.joblib"
    ...
    api.upload_file(
        path_or_fileobj="best_toursim_opt_model_v1.joblib",
        path_in_repo="best_toursim_opt_model_v1.joblib",
        repo_id=repo_id,
        repo_type=repo_type,
    )
